...
object ItemCF {
  def main(args: Array[String]): Unit = {
    ...
    //2.读取数据
    val data_path = "/Users/mac/workspace/itemCF/src/main/scala/com/t9vg/itemCF/sample_itemCF.txt"
